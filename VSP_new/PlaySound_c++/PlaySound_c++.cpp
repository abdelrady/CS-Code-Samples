//----------------------------------------------------------------------------
// File: PlaySound_c++.cpp
//
// Desc: The PlaySound_c++ sample shows how to load and play a wave file using
...
HRESULT OnPlaySound_c++( HWND hDlg );
        ...
        case WM_COMMAND:
            switch( LOWORD(wParam) )
            {
                ...
                case IDC_PLAY:
                    ...
                    if( FAILED( hr = OnPlaySound_c++( hDlg ) ) )
                    {
                        DXTRACE_ERR_MSGBOX( TEXT("OnPlaySound_c++"), hr );
