<%@ Page language="c#" Codebehind="postarticle.aspx.cs" AutoEventWireup="false" Inherits="csharphome.manage.editors.postarticle" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title><!-- #include virtual="../../title.inc" --> - Home Management - Articles - Post Article</title>
			...
			<p>
				<TABLE id="Table1" cellSpacing="1" cellPadding="1" width="100%" border="0">
					<TR>
						...
						<TD vAlign="top"><h3>Post Article</h3>
							<P>
							...
							<TABLE id="Table2" cellSpacing="1" cellPadding="1" width="100%" border="0">
								<TR>
									...
									<TD>
										<asp:TextBox id="txtArticleSubject" runat="server" Width="289px"></asp:TextBox></TD>
								</TR>
								<TR>
								...
								<TR>
									<TD style="WIDTH: 84px" vAlign="top">HTML Tools</TD>
									<TD vAlign="top">
								...
								<TR>
									...
									<TD>
										<asp:TextBox id="txtArticle" runat="server" TextMode="MultiLine" Width="523px" Height="200px"></asp:TextBox>
									</TD>
								</TR>
								<TR>
									<TD style="WIDTH: 84px"></TD>
									<TD>
										<asp:Button id="btnPostArticle" runat="server" Text="Post Article"></asp:Button>
									</TD>
								</TR>
							</TABLE>
							<% } %>
