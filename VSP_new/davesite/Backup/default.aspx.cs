...
namespace csharphome
{
	...
	public class WebForm1 : System.Web.UI.Page
	{
		...
		protected System.Web.UI.WebControls.Literal liArticles;
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			liArticles.Text = f.loadArticleList(Request.MapPath(strDatabase), Convert.ToBoolean(Request.QueryString["showall"]));
		}
