...
namespace tapi1_cs
{
    public class TAPI
    {
        ...
        public static LPLINEINITIALIZEEXPARAMS LPLINEINITIALIZEEXPARAMS1;
        ...
        public struct LPLINEINITIALIZEEXPARAMS
       {
            int dwTotalSize;  int dwNeededSize;  int dwUsedSize;  int dwOptions;
        ...
        public static extern long lineGetID(int hLine, int dwAddressID, int hCall, int dwSelect, varString lpDevice, string lpszDeviceClass);
        [DllImport("Tapi32.dll", SetLastError = true)]
        ...
        [DllImport("Tapi32.dll", SetLastError = true)]
        public static extern int lineInitializeEx(ref int hTAPI, int
        hInst, LineCallBackDelegate fnPtr,
        ref int szAppName, ref int dwNumLines, int lpdwAPIVersion,ref LPLINEINITIALIZEEXPARAMS otherParams);
