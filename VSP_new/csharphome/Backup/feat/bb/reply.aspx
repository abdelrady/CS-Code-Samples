<%@ Page language="c#" Codebehind="reply.aspx.cs" AutoEventWireup="false" Inherits="csharphome.feat.bb.reply" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title><!-- #include virtual="../../title.inc" --> - Message Board - Reply to Message</title>
							...
							<P>
								<TABLE id="Table3" style="HEIGHT: 169px" cellSpacing="1" cellPadding="1" width="100%" border="0">
									<TR>
										...
										<TD>
											<asp:textbox id="txtSubject" runat="server" MaxLength="255" Width="243px"></asp:textbox></TD>
									</TR>
									<TR>
										<TD style="WIDTH: 74px; HEIGHT: 29px">Post icon</TD>
										<TD>
											<INPUT type="radio" CHECKED value="1" name="msg_icon"> <IMG alt="Icon 1" src="../../images/icons/icon1.gif" align="middle">&nbsp;&nbsp;&nbsp;&nbsp;
											...
											<INPUT type="radio" value="14" name="msg_icon"> <IMG alt="Icon 14" src="../../images/icons/icon14.gif" align="middle">&nbsp;&nbsp;&nbsp;&nbsp;</TD>
									</TR>
									<TR>
