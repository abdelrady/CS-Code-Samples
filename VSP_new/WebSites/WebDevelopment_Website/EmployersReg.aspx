    ...
    <table border="0" cellpadding="0" cellspacing="0" width="456" background="imagenew/sn_bk.jpg">
        ...
        <tr>
            ...
            <td align="left" valign="top" width="330">
                <img height="2" src="images/space.gif" width="1" /><br />
                &nbsp;<br />
                <asp:TextBox ID="TextBox8" runat="server" Width="233px" OnTextChanged="TextBox8_TextChanged"></asp:TextBox>
                <img height="2" src="images/space.gif" width="1" id="IMG3" language="javascript" onclick="return IMG3_onclick()" /><br />
                <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ControlToValidate="TextBox8"
                    EnableViewState="False" ErrorMessage="Phone Number Must be numbers of length 10"
        ...
        <tr>
            <td align="middle" valign="top" width="10" style="height: 64px">
                <img height="6" src="images/space.gif" width="5" /><br />
                <img height="5" src="images/red.gif" width="5" /><img
                    height="2" src="images/space.gif" width="5" /></td>
            <td valign="top" width="110" style="height: 64px">
                <img height="2" src="images/space.gif" width="110" /><br />
                ...
                <br />
                <img height="2" src="images/space.gif" width="110" /></td>
            <td bgcolor="#c9d1f2" width="1" style="height: 64px">
                <img height="10" src="images/space.gif"
                    width="1" /></td>
            <td width="5" style="height: 64px">
                <img height="10" src="images/space.gif"
                    width="5" /></td>
            <td align="left" valign="top" width="330" style="height: 64px">
                <img height="2" src="images/space.gif" width="1" /><br />
                &nbsp;<br />
                ...
                <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="TextBox9"
                    ErrorMessage="Email Must be in userName@website_Name.anyThing" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*"></asp:RegularExpressionValidator></td>
        </tr>
        <tr>
            <td bgcolor="#c9d1f2" colspan="5" height="1">
                <img height="1" src="images/space.gif" width="456" /></td>
        ...
        <tr>
            ...
            <td align="left" valign="top" width="330">
                ...
                <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" ControlToValidate="TextBox10"
                    ErrorMessage="Your Website must be Valid URL" ValidationExpression="http(s)?://([\w-]+\.)+[\w-]+(/[\w- ./?%&=]*)?"></asp:RegularExpressionValidator></td>
        </tr>
        <tr>
            <td bgcolor="#c9d1f2" colspan="5" height="1">
                <img height="1" src="images/space.gif" width="456" /></td>
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="456" background="imagenew/sn_bk.jpg">
        ...
        <tr>
            <td>
                &nbsp;</td>
            <td colspan="4">
                    <asp:CheckBox ID="CheckBox1" runat="server" Height="30px" OnCheckedChanged="CheckBox1_CheckedChanged1" Text="Click To Accept <a onclick=&quot;showModelessDialog('EmptyPolicy.aspx');&quot; style=&quot;color:Blue;text-decoration:underline;&quot;>website Terms</a>" Width="338px" AutoPostBack="True" /><br />
                </td>
        </tr>
        <tr>
