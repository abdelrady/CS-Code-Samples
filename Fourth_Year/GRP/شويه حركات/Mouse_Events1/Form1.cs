...
namespace Mouse_Events1
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
           ...
           */
            ret = SetCursorPos(100, 650);
            mouse_event (0x2, 20, 750, 0, 0);
            mouse_event (0x4, 20, 750, 0, 0);
            mouse_event(0x2, 20, 750, 0, 0);
            mouse_event(0x4, 20, 750, 0, 0);
            ret = SetCursorPos(300, 650);
            mouse_event(0x0800, 300, 650, -1120, 0);
        }
        ...
        {
            this.Text = e.Button.ToString() + " " + e.X.ToString() + " " + e.Y.ToString();
        }
