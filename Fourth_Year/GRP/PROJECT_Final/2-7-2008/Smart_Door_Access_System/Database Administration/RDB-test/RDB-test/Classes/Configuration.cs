    ...
    class Configuration
    {
        ...
        private static void SetConfigurationAttributes(string[] p)
        {
            try
            {
                ...
                userName = p[3].Split('=')[1];
                userPassword = p[4].Split('=')[1];
            }
            catch { }
        }
        ...
        public static string[] Parse_Values(string Value)
        {
            /*
             * By Eagle
             */
        ...
        internal static bool Valid()
        {
            ...
            catch
            {
                ...
                Write_Config(@"Data Source=.\SQLEXPRESS;Initial catalog='SDASDB';Integrated Security=True;Connect Timeout=40;User Instance=True;User ID=;Password=");
                return false;
            }
            if (connectionString == "")
            {
        ...
        internal static void Write_Config(string userName, string userPassword, string ServerName, string DBName, string IntegratedSecurity, string ConnectionTimeout, string UserInstance)
        {
            ...
            Writer.WriteLine("connectionString=" + "Data Source=" + Configuration.ServerName + ';' + "Initial Catalog=" + Configuration.DBName + ';'
                + "Integrated Security=" + Configuration.IntegratedSecurity + ';' + "User ID=" + Configuration.userName + ';' +
