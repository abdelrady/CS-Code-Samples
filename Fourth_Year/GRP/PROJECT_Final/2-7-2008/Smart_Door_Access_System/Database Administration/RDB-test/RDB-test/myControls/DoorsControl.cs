...
namespace RDB_test.myControls
{
    public partial class DoorsControl : UserControl
    {
        ...
        private void employeeControl_Load(object sender, EventArgs e)
        {
            ...
            this.users_DoorsTableAdapter.Connection.ConnectionString = Configuration.connectionString;
        ...
        private void DoorsDataGridView_SelectionChanged(object sender, EventArgs e)
        {
            ...
            //MessageBox.Show(users_DoorsTableAdapter.Connection.ConnectionString);
        }
       ...
       /* private void GroupsGridView_CellContentClick(object sender, DataGridViewCellEventArgs e)
        ...
        private void findToolStripLabel_Click(object sender, EventArgs e)
        {

        }

        private void iDLabel_Paint(object sender, PaintEventArgs e)
        {
