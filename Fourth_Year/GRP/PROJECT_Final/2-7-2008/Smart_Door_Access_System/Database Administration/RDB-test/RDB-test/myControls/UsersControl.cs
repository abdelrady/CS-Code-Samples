...
namespace RDB_test.myControls
{
    public partial class UsersControl : UserControl
    {
        ...
        private void ImportImage(string filename)
        {
            ...
            {
                MessageBox.Show("Soory Image Size Must Be Less Than 100KB", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
        ...
        private void toolStripButton1_Click(object sender, EventArgs e)
        {
            try
            {
                this.sDASDBDataSet.Users.Clear();
                this.usersTableAdapter1.Fill(this.sDASDBDataSet.Users);
            }
            catch (System.Exception ex)
            {
        ...
        private void imagePictureBox_BindingContextChanged(object sender, EventArgs e)
        {
            //MessageBox.Show(e.ToString()+sender.ToString());
        }

        private void UsersControl_Paint(object sender, PaintEventArgs e)
        {
