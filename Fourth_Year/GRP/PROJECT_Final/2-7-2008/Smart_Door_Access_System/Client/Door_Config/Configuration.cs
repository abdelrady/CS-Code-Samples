...
namespace SmartDoor
{
    class Configuration
    {
        ...
        public static void Read_Config()
        {
            ...
            FileStream fs = new FileStream(Application.ExecutablePath.Substring(0,Application.ExecutablePath.LastIndexOf("\\"))+ "\\Data\\Config.ini", FileMode.Open, FileAccess.Read, FileShare.ReadWrite);
            ...
            //{
                ...
                reader.Close();
            //}
            //catch (Exception ex) { MessageBox.Show("Empty Configuration File."); }
        }
        ...
        {
            Process.Start(Application.ExecutablePath.Substring(0,Application.ExecutablePath.LastIndexOf("\\"))+ "\\Data\\Config.ini");
        }
            ...
            string p_18)
        {
            ...
            CryptoStream cs = new CryptoStream(File.Create(Application.ExecutablePath.Substring(0,Application.ExecutablePath.LastIndexOf("\\"))+ "\\Data\\Config.ini"), ri.CreateEncryptor(), CryptoStreamMode.Write);
