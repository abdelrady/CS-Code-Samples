...
namespace SmartDoor
{
    class Configuration
    {
        ...
        public static string WaitOnOpened = "";
        public static string LptPortAddressBase = "";
        ...
        public static void Read_Config()
        {
            ...
            WaitOnOpened = Parse_Value(reader.ReadLine());
            LptPortAddressBase = Parse_Value(reader.ReadLine());
