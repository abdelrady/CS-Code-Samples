...
Begin VB.Form Scanner_Activation_Form 
   ...
   Begin VB.Label Label3 
      Caption         =   $"Scanner_Activation_Form.frx":030A
      Height          =   1725
      Left            =   2250
      TabIndex        =   7
      Top             =   180
...
Private Sub Form_KeyPress(KeyAscii As Integer)
    ...
    'Here ASCII 126 is used to start a process; ASCII chart: http://www.idautomation.com/ascii-table.html
    'ASCII 126 (the tilde key) can be entered from the keyboard to manually start the process
