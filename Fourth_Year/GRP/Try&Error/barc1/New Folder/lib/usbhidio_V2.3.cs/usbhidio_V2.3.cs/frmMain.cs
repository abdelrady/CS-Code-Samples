...
namespace HID_Test_Application
{
    ...
    private System.ComponentModel.IContainer components;
		...
		[System.Diagnostics.DebuggerStepThrough()]private void InitializeComponent ()
		{
            ...
            this.lblFeatureRepLength.Size = new System.Drawing.Size(53, 13);
              ...
              _MyHID.DeviceAttributes.Size = Marshal.SizeOf(_MyHID.DeviceAttributes);
							...
							if (Result != 0) {
								...
								if ((_MyHID.DeviceAttributes.VendorID == MyVendorID) & 
									...
									lstResults.Items.Add("Device detected222:");
    ...
    void MyMarshalToForm(string action, string textToDisplay)
    {
        ...
        object[] args=new object[] {action, textToDisplay};
		...
		private void ReadAndWriteToDevice ()
		{
			...
			try {
				...
				if (_MyDeviceDetected) {
                    ...
                    // GRV-moved this to fix increment BEFORE send bytes bug
