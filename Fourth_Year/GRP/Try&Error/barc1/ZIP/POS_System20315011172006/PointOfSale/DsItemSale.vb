...
Public Class DsItemSale
    ...
    Public Overrides Function Clone() As DataSet
        Dim cln As DsItemSale = CType(MyBase.Clone,DsItemSale)
        cln.InitVars
        Return cln
    End Function
    ...
    Private Sub InitClass()
        Me.DataSetName = "DsItemSale"
        Me.Prefix = ""
        Me.Namespace = "http://www.tempuri.org/DsItemSale.xsd"
    ...
    Public Class SaleByItemDataTable
        ...
        Public Overloads Function AddSaleByItemRow(ByVal Barcode As String, ByVal BillNo As String, ByVal Description As String, ByVal Qty As Integer, ByVal SaleDate As Date, ByVal Total As Decimal, ByVal UnitPrice As Decimal) As SaleByItemRow
            Dim rowSaleByItemRow As SaleByItemRow = CType(Me.NewRow,SaleByItemRow)
            rowSaleByItemRow.ItemArray = New Object() {Barcode, BillNo, Description, Qty, SaleDate, Total, UnitPrice}
    ...
    Public Class SaleByItemRow
        ...
        Public Property Barcode As String
            Get
                Try 
                    Return CType(Me(Me.tableSaleByItem.BarcodeColumn),String)
                Catch e As InvalidCastException
                    Throw New StrongTypingException("Cannot get value because it is DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tableSaleByItem.BarcodeColumn) = value
            End Set
        End Property
        ...
        Public Property BillNo As String
            Get
                Try 
                    Return CType(Me(Me.tableSaleByItem.BillNoColumn),String)
                Catch e As InvalidCastException
                    Throw New StrongTypingException("Cannot get value because it is DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tableSaleByItem.BillNoColumn) = value
            End Set
        End Property
        ...
        Public Property SaleDate As Date
            Get
                Try 
                    Return CType(Me(Me.tableSaleByItem.SaleDateColumn),Date)
                Catch e As InvalidCastException
                    Throw New StrongTypingException("Cannot get value because it is DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tableSaleByItem.SaleDateColumn) = value
            End Set
        End Property
        ...
        Public Function IsBarcodeNull() As Boolean
            Return Me.IsNull(Me.tableSaleByItem.BarcodeColumn)
        End Function
        
        Public Sub SetBarcodeNull()
            Me(Me.tableSaleByItem.BarcodeColumn) = System.Convert.DBNull
        End Sub
        
        Public Function IsBillNoNull() As Boolean
            Return Me.IsNull(Me.tableSaleByItem.BillNoColumn)
        End Function
        
        Public Sub SetBillNoNull()
            Me(Me.tableSaleByItem.BillNoColumn) = System.Convert.DBNull
        End Sub
        ...
        Public Function IsSaleDateNull() As Boolean
            Return Me.IsNull(Me.tableSaleByItem.SaleDateColumn)
        End Function
        
        Public Sub SetSaleDateNull()
            Me(Me.tableSaleByItem.SaleDateColumn) = System.Convert.DBNull
        End Sub
