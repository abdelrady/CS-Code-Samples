...
Public Class DsSaleByItem
    ...
    Public Overrides Function Clone() As DataSet
        Dim cln As DsSaleByItem = CType(MyBase.Clone,DsSaleByItem)
        cln.InitVars
        Return cln
    End Function
    ...
    Private Sub InitClass()
        Me.DataSetName = "DsSaleByItem"
        Me.Prefix = ""
        Me.Namespace = "http://www.tempuri.org/DsSaleByItem.xsd"
    ...
    Public Class SaleByItemDataTable
        ...
        Public Overloads Function AddSaleByItemRow(ByVal BillNo As String, ByVal Description As String, ByVal ItemCode As String, ByVal Qty As Integer, ByVal SaleDate As Date, ByVal Total As Decimal, ByVal UnitPrice As Decimal) As SaleByItemRow
            Dim rowSaleByItemRow As SaleByItemRow = CType(Me.NewRow,SaleByItemRow)
            rowSaleByItemRow.ItemArray = New Object() {BillNo, Description, ItemCode, Qty, SaleDate, Total, UnitPrice}
    ...
    Public Class SaleByItemRow
        ...
        Public Function IsItemCodeNull() As Boolean
            Return Me.IsNull(Me.tableSaleByItem.ItemCodeColumn)
        End Function
        
        Public Sub SetItemCodeNull()
            Me(Me.tableSaleByItem.ItemCodeColumn) = System.Convert.DBNull
        End Sub
