...
document.itxtInProg=1;var itxtIas='3ccfb46013034060a5b09ba38c19ac39';
var itxtIasCD=0;
var itxtIasED=1207240829000;
...
{
var itxturl='http://codeproject.us.intellitxt.com/v3/door.jsp?ts='+(new Date()).getTime()+'&pagecl='+itxtbtl()+'&enc='+itxtGCE()+'&ias='+itxtIas+'|'+itxtIasCD+'|'+itxtIasED+'&ipid=5102';
