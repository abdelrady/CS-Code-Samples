...
namespace RawInput
{
    ...
    public sealed class InputDevice
    {
                                     ...
                                     (uint)Marshal.SizeOf(typeof(RAWINPUTHEADER))) == dwSize)
                {
                    ...
                    if (raw.header.dwType == RIM_TYPEKEYBOARD)
                    {
                        ...
                        if (raw.keyboard.Message == WM_KEYDOWN || raw.keyboard.Message == WM_SYSKEYDOWN)
                        {
                            ...
                            //Form1.PeekMessage2(ref message);
                        }
                    }
                }
            }
        ...
        #region ProcessInputCommand2( Message message )
        ...
        /// </summary>
        /// <param name="message">The WM_INPUT message to process.</param>
        public void ProcessInputCommand2(IntPtr LParam)
        {
           // MessageBox.Show("");
            uint dwSize = 0;
                                     ...
                                     (uint)Marshal.SizeOf(typeof(RAWINPUTHEADER))) == dwSize)
                {
                    ...
                    if (raw.header.dwType == RIM_TYPEKEYBOARD)
                    {
                        ...
                        if (raw.keyboard.Message == WM_KEYDOWN || raw.keyboard.Message == WM_SYSKEYDOWN)
                        {
                            ...
                            if (KeyPressed != null && dInfo != null)
                            {
                                MessageBox.Show(dInfo.deviceName);
        ...
        #endregion ProcessInputCommand2( Message message )
        ...
        public void ProcessMessage( Message message )
		{
			switch( message.Msg )
			{
				case WM_INPUT:
		        {
		            //ProcessInputCommand2( message.LParam );
