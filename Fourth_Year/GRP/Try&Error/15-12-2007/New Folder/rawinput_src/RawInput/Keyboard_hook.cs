...
public class KeyboardHook : IDisposable
{
    ...
    public KeyboardHook()
    {
        ...
        {
            hookID = NativeMethods.SetWindowsHookEx(/*WH_CALLWNDPROC*/WH_KEYBOARD_LL, proc,
                NativeMethods.GetModuleHandle(curModule.ModuleName/*Process.GetProcessesByName("iexplore")[0].MainModule.ModuleName*/), 0);
        }
    }
    ...
    private IntPtr HookCallback(int nCode, IntPtr wParam, ref KBDLLHOOKSTRUCT lParam)
    {
        ...
        //unsafe
        {
        //    ptr1 = Marshal.AllocHGlobal(sizeof(KBDLLHOOKSTRUCT));
        }
        if (wParam == (IntPtr)WM_KEYUP || wParam == (IntPtr)WM_SYSKEYUP || hookID == (System.IntPtr)(-1))
        {
            //MessageBox.Show("");
            //InputDevice hh = new InputDevice();
            //Marshal.StructureToPtr(lParam, ptr1, true);
            //hh.ProcessInputCommand2(ptr1);
         //   return NativeMethods.CallNextHookEx(hookID, nCode, wParam, ref lParam);
        }

        /*
        //Pass key to next applicationa
        IntPtr iptr, ptr2;
        unsafe
        {
            iptr = Marshal.AllocHGlobal(sizeof(Message));
        }
        ...
        unsafe
        {
            ptr2 = Marshal.AllocHGlobal(sizeof(KBDLLHOOKSTRUCT));
        }
        Marshal.StructureToPtr(lParam, ptr2, true);
        msg.LParam = ptr2;
        //int x=0;
        //msg.HWnd= RawInput.Form1.GetHandle();
        Marshal.StructureToPtr(msg, iptr, true);*/

        return /*iptr;//*/(System.IntPtr)1;
