...
Microsoft.Mtps.Web.UI.TagAutoCompleteBehavior = function(element) {
    /// <summary>
    ...
    /// </param>
    /// <returns />
    Microsoft.Mtps.Web.UI.TagAutoCompleteBehavior.initializeBase(this, [element]);
...
Microsoft.Mtps.Web.UI.TagAutoCompleteBehavior.prototype = {
    initialize: function() {
        /// <summary>
        /// Initializes the autocomplete behavior.
        /// </summary>
        /// <returns />
        Microsoft.Mtps.Web.UI.TagAutoCompleteBehavior.callBaseMethod(this, 'initialize');
    ...
    dispose: function() {
        ...
        Microsoft.Mtps.Web.UI.TagAutoCompleteBehavior.callBaseMethod(this, 'dispose');
    },
    ...
    _highlightItem: function(item) {
        ...
        for (var i = 0; i < children.length; i++) {
            ...
            if (child._highlighted) {
                ...
                this.raiseItemOut(new Microsoft.Mtps.Web.UI.TagAutoCompleteItemEventArgs(child, child.firstChild.nodeValue));
            }
        }
        ...
        this.raiseItemOver(new Microsoft.Mtps.Web.UI.TagAutoCompleteItemEventArgs(item, item.firstChild.nodeValue));
    },
    ...
    _setText: function(item) {
        ...
        this.raiseItemSelected(new Microsoft.Mtps.Web.UI.TagAutoCompleteItemEventArgs(item, text));
    ...
    raiseItemSelected : function(eventArgs) {
        ...
        /// </summary>
        /// <param name="eventArgs" type="Microsoft.Mtps.Web.UI.TagAutoCompleteItemEventArgs" mayBeNull="false">
...
Microsoft.Mtps.Web.UI.TagAutoCompleteBehavior.registerClass('Microsoft.Mtps.Web.UI.TagAutoCompleteBehavior', AjaxControlToolkit.BehaviorBase);
Microsoft.Mtps.Web.UI.TagAutoCompleteBehavior.descriptor = {
...
Microsoft.Mtps.Web.UI.TagAutoCompleteItemEventArgs = function(item, text) {
    /// <summary>
    ...
    /// Text of the item
    /// </param>
    Microsoft.Mtps.Web.UI.TagAutoCompleteItemEventArgs.initializeBase(this);
    
    this._item = item;
    this._text = text;
}
Microsoft.Mtps.Web.UI.TagAutoCompleteItemEventArgs.prototype = {
    get_item : function() {
        /// <value type="Sys.UI.DomElement" DomElement="true" mayBeNull="true">
        /// Item
        /// </value>
...
Microsoft.Mtps.Web.UI.TagAutoCompleteItemEventArgs.registerClass('Microsoft.Mtps.Web.UI.TagAutoCompleteItemEventArgs', Sys.EventArgs);
