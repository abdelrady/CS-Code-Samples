...
document.itxtInProg=1;var itxtIas='ccdf896100d64d9f989c340ece4919ac';
var itxtIasCD=0;
var itxtIasED=1207705613;
...
{
var itxturl='http://codeproject.us.intellitxt.com/v3/door.jsp?ts='+(new Date()).getTime()+'&pagecl='+itxtbtl()+'&enc='+itxtGCE()+'&ias='+itxtIas+'|'+itxtIasCD+'|'+itxtIasED+'&ipid=5102&refurl='+document.location.href.replace(/\&/g,'%26').replace(/\'/g, '%27').replace(/\"/g, '%22').replace(/\#(.)*/,'');
