...
var sns = [
	 ...
	 {name:'Google',		image: 'AddTo_Google.png',		url: 'http://fusion.google.com/add?',		urlVar: 'feedurl',	titleVar: '',	noteVar: '',	returnVar: '',	otherVars: '' },
	 {name:'Spurl',			image: 'AddTo_Spurl.png',		url: 'http://www.spurl.net/spurl.php?',		urlVar: 'url',	titleVar: 'title',	noteVar: 'blocked', returnVar: '', otherVars: '&v: 3' },
	 {name:'Blink',			image: 'AddTo_Blink.png',		url: 'http://www.blinklist.com/index.php?Action: Blink/addblink.php', urlVar: 'url', titleVar: 'title', noteVar: 'description', returnVar: '', otherVars: '&Action: Blink/addblink.php' },
	 ...
	 {name:'Windows Live',	image: 'AddTo_Live.png',		url: 'https://favorites.live.com/quickadd.aspx?', urlVar: 'url', titleVar: '',	noteVar: '',	returnVar: '',	otherVars: '&marklet: 1&mkt: en-us&top: 1' },
	 {name:'Newsvine',		image: 'AddTo_Newsvine.png',	url: 'http://www.newsvine.com/_wine/save?',	urlVar: 'u',	titleVar: '',		noteVar: '',	returnVar: '',	otherVars: '' },
	 {name:'Stumbleupon',	image: 'AddTo_stumbleupon.png',	url: 'http://www.stumbleupon.com/submit?',	urlVar: 'url',	titleVar: '',		noteVar: '',	returnVar: '',	otherVars: '' }
];
