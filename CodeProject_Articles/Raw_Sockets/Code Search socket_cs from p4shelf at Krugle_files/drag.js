...
// Copyright 2006 Krugle, Inc.
// See http://www.krugle.net for terms of use.
//*****************************************************************************

// adding krugle.drag namespacing variable
...
function dragStart(event, id) {
	...
	if (isNaN(dragObj.elStartLeft)) {
		dragObj.elStartLeft = findPosX(dragObj.elNode);
	}
	if (isNaN(dragObj.elStartTop)) {
		dragObj.elStartTop = findPosY(dragObj.elNode);
	}
