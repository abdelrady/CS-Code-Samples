<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Login_vb.aspx.vb" Inherits="_Default" %>
...
<body>
    ...
    <div>
        <asp:Login ID="Login1" runat="server" BackColor="#F7F7DE" BorderColor="#CCCC99" BorderStyle="Solid"
            ...
            RememberMeText="ÊÐßÑäí" TitleText="ÏÎæá" UserNameLabelText="ÃÓã ÇáãÓÊÎÏã" DestinationPageUrl="~/EditProfile.aspx">
