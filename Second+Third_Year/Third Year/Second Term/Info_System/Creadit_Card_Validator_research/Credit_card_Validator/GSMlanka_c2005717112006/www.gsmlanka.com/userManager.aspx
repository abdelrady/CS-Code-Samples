...
<script runat="server">
    ...
    usersql= "select userID from users where userID<>'thugslyf' order by userID"
    bcon.open
    bcmd = New SqlCommand(userSQL, Bcon)
    objreader = bcmd.ExecuteReader
    cbouser.items.add("select a user")
    while objreader.read
    cbouser.items.add(objreader("userID"))
    end while
    bcon.close
    end if
    end sub
    ...
    sub fillpriv
    if  cbopriv.items.count=0 then
    cbopriv.items.add("Member")
    cbopriv.items.add("Administrator")
    cbopriv.items.add("Moderator")
    cbopriv.items.add("Veteran")
    cbopriv.items.add("Senior Member")
    cbopriv.items.add("junior Member")
    end if
    end sub
    ...
    sub selMember(sender As Object, e As EventArgs)
    
    dim privSql as string
    call dbcon
    if cbouser.selecteditem.text<>"select a user" then
    privSql="select priviladge from users where userID='" & cbouser.selecteditem.text & " ' "
    TCMD=NEW SQLCOMMAND(privSql,bcon)
    bcon.open
    dr=tcmd.executereader
    dr.read
    cbopriv.selecteditem.text=dr("priviladge")
    bcon.close
    end if
    ...
    sub delmember( sender As Object, e As System.Web.UI.ImageClickEventArgs)
    dim delSQL as string
    
    if cbouser.selecteditem.text<>"select a user" then
    delSQL="delete from users where userID='" & cbouser.selectedItem.text & "'"
    bcon.open
    bcmd = New SqlCommand(delSQL, Bcon)
    ...
    sub updatemember( sender As Object, e As System.Web.UI.ImageClickEventArgs)
    
    mcmd= new sqlcommand("update users set priviladge='" & cbopriv.selecteditem.text & "' where userId='"& cbouser.selecteditem.text &"'",bcon)
    bcon.open
                                ...
                                <tr>
                                    ...
                                    <td valign="top">
                                        <table class="border4" cellspacing="0" cellpadding="0" width="100%" background="imagenew/sn_bk.jpg" border="0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td class="redfont" valign="top" colspan="6" height="27">
                                                        &nbsp;&nbsp; select a user to modify/delete 
                                                    </td>
                                                    <td width="33">
                                                        &nbsp;</td>
                                                    <td width="14">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="leftlink1" valign="center" align="right" width="103">
                                                        User ID : 
                                                    </td>
                                                    <td width="9">
                                                        &nbsp;</td>
                                                    <td valign="top" colspan="4">
                                                        <asp:DropDownList id="cbouser" runat="server" AutoPostBack="true" OnSelectedIndexChanged="selmember"></asp:DropDownList>
                                                    </td>
                                                    <td>
                                                        &nbsp;</td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        &nbsp;</td>
                                                    <td valign="top" colspan="4">
                                                        <asp:DropDownList id="cboPriv" runat="server"></asp:DropDownList>
                                                    </td>
                                                    <td>
                                                        &nbsp;</td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        &nbsp;</td>
                                                    <td valign="top">
                                                        <asp:ImageButton id="cmdupdate" onclick="updatemember" runat="server" imageurl="buttons/updatesmal.jpg"></asp:ImageButton>
                                                    </td>
                                                    <td>
                                                        &nbsp;</td>
                                                    <td valign="top" colspan="3">
                                                        <asp:ImageButton id="cmddel" onclick="delmember" runat="server" imageurl="buttons/delete_selectphone.jpg"></asp:ImageButton>
                                                    </td>
                                                    <td>
                                                        &nbsp;</td>
                                                </tr>
