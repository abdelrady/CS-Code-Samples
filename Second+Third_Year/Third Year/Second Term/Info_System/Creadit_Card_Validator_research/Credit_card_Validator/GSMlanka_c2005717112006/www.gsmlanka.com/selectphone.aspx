...
<script runat="server">
    ...
    sub selphone(sender As Object, e As EventArgs)
    
    
    cbophoneid.items.clear
    
    dim phoneSQL as string
    call dbcon
    phoneSQL= "select phoneID,man_ID from phone_details where man_id=(select man_ID from manufacturer where man_name='"& cboMAn.selecteditem.text & "' )"
    bcon.open
    bcmd = New SqlCommand(phoneSQL, Bcon)
    objreader = bcmd.ExecuteReader
    cbophoneid.items.add("select a phone")
    while objreader.read
    cbophoneid.items.add(objreader("phoneID"))
    manidpass=objreader("man_ID")
    end while
    bcon.close
    ...
    sub delphone( sender As Object, e As System.Web.UI.ImageClickEventArgs)
    dim delSQL as string
    
    if cbophoneID.selecteditem.text<>"" then
    delSQL="delete from phone_details where phoneID='" & cbophoneID.selectedItem.text & "'"
    bcon.open
    ...
    sub viewPhone( sender As Object, e As System.Web.UI.ImageClickEventArgs)
    
    Dim Man_name,PhoneID As String
    
    Response.Redirect("modifyphone.aspx?man_Name=" & cstr(trim(cboman.selecteditem.text)) & _
    "&PhoneID=" & cbophoneID.selecteditem.text)
    
    end sub
    
    sub enablebuttons(sender As Object, e As EventArgs)
    if cbophoneID.selecteditem.text<>"select a phone" then
...
<html>
<head>
    <title>GSMLanka - Phone Manager-Select a phone</title>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td valign="top" colspan="3">
                                                        <asp:DropDownList id="cboMan" runat="server" AutoPostBack="true" OnSelectedIndexChanged="selphone"></asp:DropDownList>
                                                    </td>
                                                    <td>
                                                        &nbsp;</td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        &nbsp;</td>
                                                    <td valign="top" colspan="3">
                                                        <asp:DropDownList id="cboPhoneID" runat="server" AutoPostBack="true" OnSelectedIndexChanged="enablebuttons"></asp:DropDownList>
                                                    </td>
                                                    <td>
                                                        &nbsp;</td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        &nbsp;</td>
                                                    <td valign="top">
                                                        <asp:ImageButton id="edit" onclick="viewPhone" runat="server" Enabled="false" imageurl="buttons/edit_selectphone.jpg"></asp:ImageButton>
                                                    </td>
                                                    <td>
                                                        &nbsp;</td>
                                                    <td valign="top" colspan="2">
                                                        <asp:ImageButton id="del" onclick="delPhone" runat="server" imageurl="buttons/delete_selectphone.jpg" enabled="false"></asp:ImageButton>
                                                    </td>
                                                    <td>
                                                        &nbsp;</td>
                                                </tr>
