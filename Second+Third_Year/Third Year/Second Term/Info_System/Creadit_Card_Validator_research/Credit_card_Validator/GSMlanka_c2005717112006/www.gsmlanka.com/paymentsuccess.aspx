...
<script runat="server">
    ...
    if session("userid")="" or session.SessionID<>request.QueryString("transID")
    response.redirect("login.aspx")
    else
    lbluser.text=session("userid")
    lblmail.text=session("cusemail")
    lblordID.text=session("orderID")
    end if
...
<html>
<head>
    <title>GSM Lanka - Transaction completed</title>
                        ...
                        <table cellspacing="0" cellpadding="0" width="100%" border="0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td valign="top">
                                        <p>
                                            <span class="redfont">Dear</span> <asp:Label id="lbluser" runat="server" font-bold="true" font-size="10"></asp:Label>
                                        </p>
                                        <p>
                                            <span class="style4">Thank you for purchasing @ GSMLanka<sup>®</sup> - Internet phone
                                            shop,your order details are given below, please: use this order ID to check the status
                                            of your order delvery status.</span> 
                                        </p>
                                        <p>
                                            <span class="redfont">order ID:</span> <asp:Label id="lblordID" runat="server" cssclass="redfont"></asp:Label>
                                        </p>
                                        <p>
                                            <span class="style4">. a conformation email has been sent to</span> <asp:Label id="lblmail" runat="server" font-bold="true" font-size="10"></asp:Label>, <span class="style4">regarding
                                            your payment details.</span> 
                                        </p>
                                        <p class="redfont" align="center">
                                            <a href="index.aspx">click here to go to the home page</a> 
                                        </p>
                                        <p class="style4">
                                            thank you, 
                                        </p>
                                        <p class="redfont">
                                            webmaster@GSMLanka.com 
                                        </p>
                                    </td>
                                    <td>
                                        &nbsp;</td>
