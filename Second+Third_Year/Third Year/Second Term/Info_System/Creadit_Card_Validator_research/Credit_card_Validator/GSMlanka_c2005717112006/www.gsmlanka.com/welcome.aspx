...
<script runat="server">
    ...
    if session("userid")="" or session("valid")="" then
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td valign="top">
                                        ...
                                        <p align="justify">
                                            <span class="style4">Welcome to GSMLanka<sup>®</sup> - Internet phone shop, thank
                                            you for registering with our website. Now you have the full access to the site, you
                                            can purchase your favorite phones,rate them and discuss with experts in the discussion
                                            board @ GSMLanka<sup>®</sup>. a conformation email has been sent to</span> <asp:Label id="lblmail" runat="server" font-bold="true" font-size="10"></asp:Label>, <span class="style4">regarding
                                            your member details.</span> 
                                        </p>
