...
//		flag1=false;
	...
	private void InitializeComponent() 
	{
        ...
        // first_name
        // 
        this.first_name.Location = new System.Drawing.Point(128, 76);
        ...
        this.ch_up_dob.Location = new System.Drawing.Point(16, 168);
        ...
        this.last_named.Location = new System.Drawing.Point(32, 113);
        ...
        // last_name
        // 
        this.last_name.Location = new System.Drawing.Point(128, 117);
        ...
        this.cbstage.Items.AddRange(new object[] {
            ...
            "Third Year",
            "Fourth Year"});
        this.cbstage.Location = new System.Drawing.Point(128, 161);
        ...
        // s_year
        // 
        this.s_year.Location = new System.Drawing.Point(128, 197);
        ...
        this.first_named.Location = new System.Drawing.Point(32, 70);
        ...
        this.new_dob.Location = new System.Drawing.Point(328, 175);
        ...
        this.cb5stage.Items.AddRange(new object[] {
            ...
            "Third Year",
            "Fourth Year"});
        this.cb5stage.Location = new System.Drawing.Point(360, 177);
        ...
        this.cb4stage.Items.AddRange(new object[] {
            ...
            "Third Year",
            "Fourth Year"});
        this.cb4stage.Location = new System.Drawing.Point(144, 179);
        ...
        this.gr_id.TextChanged += new System.EventHandler(this.gr_id_TextChanged);
        // 
        // groupBox8
        // 
        ...
        this.groupBox8.Size = new System.Drawing.Size(441, 186);
        ...
        this.label12.Text = "Student Stage";
        ...
        // get_course
        // 
        this.get_course.Location = new System.Drawing.Point(299, 25);
...
//		flag2=false;
	...
	void Button1Click(object sender, System.EventArgs e)
	{
        try
        {
            ...
            string query = "INSERT INTO Students (id,first_name,last_name,stage,study_year,status,help_grades) VALUES (";
            query += id.Text + ",'" + first_name.Text + "','" + last_name.Text + "'," + (cbstage.SelectedIndex + 1) + "," + s_year.Text + "," + status.SelectedIndex + "," + 0 + ")";
    ...
    */
	...
	{
		cmd=cnn.MyConnection.CreateCommand();
		cmd.CommandText="SELECT * FROM Students ORDER BY id,stage ASC";
