...
<body>
    ...
    <div>
        <div>
            <iframe id="IFRAME1" border="0" frameborder="0" height="50" scrolling="yes" src="degree.aspx"
            ...
            <asp:ImageButton ID="ImageButton11" runat="server" ImageUrl="~/25.gif" Style="z-index: 105;
                left: 601px; position: absolute; top: 547px" Width="141px" />
            ...
            <asp:ImageButton ID="ImageButton9" runat="server" ImageUrl="~/23.gif" PostBackUrl="~/departments.aspx"
                Style="z-index: 105; left: 602px; position: absolute; top: 463px" Width="141px" />
