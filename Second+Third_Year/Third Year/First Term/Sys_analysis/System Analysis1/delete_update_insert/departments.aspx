...
<body>
    ...
    <div>
    <IFRAME border=0  scrolling=yes src="department.aspx" width=100 frameBorder=0 
 height=50 style="z-index: 114; left: 3px; width: 572px; position: absolute; top: 304px; height: 396px" id="IFRAME1" ></IFRAME>
        ...
        <asp:ImageButton ID="ImageButton13" runat="server" ImageUrl="~/28.gif"
            Style="z-index: 105; left: 601px; position: absolute; top: 631px" Width="141px" />
        <asp:ImageButton ID="ImageButton12" runat="server" ImageUrl="~/26.gif"
            Style="z-index: 105; left: 602px; position: absolute; top: 587px" Width="141px" />
        <asp:ImageButton ID="ImageButton11" runat="server" ImageUrl="~/25.gif"
            Style="z-index: 105; left: 601px; position: absolute; top: 547px" Width="141px" />
        <asp:ImageButton ID="ImageButton10" runat="server" ImageUrl="~/24.gif"
            PostBackUrl="~/degrees.aspx" Style="z-index: 105; left: 601px; position: absolute;
            top: 507px" Width="141px" />
        <asp:ImageButton ID="ImageButton9" runat="server" ImageUrl="~/23.gif"
            Style="z-index: 105; left: 602px; position: absolute; top: 463px" Width="141px" PostBackUrl="~/departments.aspx" />
        <asp:ImageButton ID="ImageButton8" runat="server" ImageUrl="~/22.gif"
            Style="z-index: 105; left: 602px; position: absolute; top: 424px" Width="141px" PostBackUrl="~/goal.aspx" />
        <asp:ImageButton ID="ImageButton7" runat="server" ImageUrl="~/21.gif"
            Style="z-index: 105; left: 601px; position: absolute; top: 384px" Width="141px" />
